...
public class ApiTest {
    ...
    @Order(1)
    public void ping(){
        ResponseEntity<String> response = new RestTemplate().getForEntity(binanceApiUrl.concat("/api/v3/ping"), String.class);
    ...
    public void priceAvg(){
        ...
        ResponseEntity<RateHistoryEntity> responseEntity = new RestTemplate().getForEntity(uriComponentsBuilder.toUriString(), RateHistoryEntity.class);
